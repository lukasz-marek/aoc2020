...
class TurnRightTest {
    ...
    @Test
    fun `when by 90 degrees and NORTH, should turn EAST`() {
        // given
        val state = State(Direction.NORTH)
        val tested = TurnRight(90)
        // when
    ...
    @Test
    fun `when by 270 degrees and NORTH, should turn WEST`() {
        // given
        val state = State(Direction.NORTH)
        val tested = TurnRight(270)
        // when
        val result = tested.execute(state)
        // then
        expectThat(result) {
    ...
    @Test
    fun `when by 90 degrees and WEST, should turn NORTH`() {
        // given
    ...
    @Test
    fun `when by 270 degrees and WEST, should turn SOUTH`() {
        // given
        val state = State(Direction.WEST)
        val tested = TurnRight(270)
        // when
    ...
    @Test
    fun `when by 90 degrees and SOUTH, should turn WEST`() {
        // given
    ...
    @Test
    fun `when by 270 degrees and SOUTH, should turn EAST`() {
        // given
        val state = State(Direction.SOUTH)
        val tested = TurnRight(270)
        // when
    ...
    @Test
    fun `when by 90 degrees and EAST, should turn SOUTH`() {
        // given
    ...
    @Test
    fun `when by 270 degrees and EAST, should turn NORTH`() {
        // given
        val state = State(Direction.EAST)
        val tested = TurnRight(270)
        // when
